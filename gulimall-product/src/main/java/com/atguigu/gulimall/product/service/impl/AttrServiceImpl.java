...
//        attrEntity.setAttrName(attr.getAttrName());
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId, String type) {
        ...
        queryWrapper.eq(AttrEntity::getAttrType,ProductConstant.AttrEnum.ATTR_TYPE_BASE.getName().equalsIgnoreCase(type)?ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode():ProductConstant.AttrEnum.ATTR_TYPE_SALE.getCode());
        if(catelogId != 0){
        ...
        List<AttrRespVo> respVos = records.stream().map((attrEntity) -> {
            ...
            //1、设置分类和分组的名字
            if(ProductConstant.AttrEnum.ATTR_TYPE_BASE.getName().equalsIgnoreCase(type)){
    ...
    public List<Long> selectSearchAttrs(List<Long> attrIds) {
        List<Long> ids = baseMapper.selectSearchAttrs(attrIds);
        return ids;
    }
