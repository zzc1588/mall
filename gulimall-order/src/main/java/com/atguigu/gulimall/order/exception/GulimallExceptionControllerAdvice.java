...
public class GulimallExceptionControllerAdvice {
    ...
    public R handleNoStockException(NoStockException e, RedirectAttributes attributes){
        log.error("sku商品库存不足，商品id：{}",e.getSkuId());
        attributes.addAttribute("msg","下单失败：库存不足，锁定库存失败");
